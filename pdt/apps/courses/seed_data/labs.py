...
LABS: list[dict] = [{'topic_title': 'Fundamentos de Linux',
 ...
 {'topic_title': 'Centralized Logging',
  ...
  'spec': {'scenario': 'Uma dessas três linhas de log vai parar num sistema de log '
                       ...
                       'qual.',
           'lines': ["logger.info(f'Login: user={user.email}')",
