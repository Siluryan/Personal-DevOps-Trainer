...
que existem.</li>
            ...
            "questions": [
                q("`docker run` faz:",
                  ...
                  ["Compila a imagem a partir de um Dockerfile local, mesmo sem necessidade real.", "Sobe um serviço de registry para guardar imagens, mesmo sem necessidade real.", "Remove um volume e os dados persistidos nele, mesmo sem necessidade real."],
                ...
                q("Diferença entre image e container:",
                  ...
                  ["Imagem e container são exatamente a mesma coisa, sem diferença, mesmo sem necessidade real.", "A imagem muda de conteúdo sozinha a cada execução, mesmo sem necessidade real.", "O container é só um registro estatístico de uso, mesmo sem necessidade real."],
                ...
                q("`COPY` vs `ADD`:",
                  ...
                  ["COPY e ADD fazem exatamente a mesma coisa, sem diferença alguma, mesmo sem necessidade real.", "ADD costuma ser considerado a opção superior mesmo em casos simples, mesmo sem necessidade real.", "COPY está depreciado e não deve mais ser usado no Dockerfile, mesmo sem necessidade real."],
                ...
                q("Imagem de 1 GB para Python:",
                  ...
                  ["Esse tamanho já é considerado ideal para imagem Python, mesmo sem necessidade real.", "Esse tamanho já é o menor tecnicamente possível para Python, mesmo sem necessidade real.", "Esse tamanho é necessário na grande maioria dos casos, mesmo sem necessidade real."],
...
de ataque de tudo que ainda está tecnicamente disponível para deploy.</li>
            ...
            "questions": [
                q("Distroless serve para:",
                  ...
                  ["Funciona só para imagens escritas em Python, mesmo sem necessidade real.", "Aumentar o volume de logs gerados pela imagem, mesmo sem necessidade real.", "Ter maior performance de rede entre containers, mesmo sem necessidade real."],
                ...
                q("Imagem alpine é:",
                  ...
                  ["Costuma ser mais lenta que outras distros base, mesmo sem necessidade real.", "Tecnicamente idêntica à imagem base do Debian, mesmo sem necessidade real.", "Não inclui alguma implementação de libc na imagem, mesmo sem necessidade real."],
                ...
                q("Capabilities padrão do Docker:",
                  ...
                  ["São imutáveis e não podem ser alteradas pelo operador, mesmo sem necessidade real.", "Devem ser ampliadas para cobrir qualquer cenário futuro, mesmo sem necessidade real.", "Não importam de verdade para a segurança do container, mesmo sem necessidade real."],
...
raio de impacto do outro, sem segmentação nenhuma entre eles.</li>
            ...
            "questions": [
                q("Docker Hub público é:",
                  ...
                  ["Um substituto direto e completo do GHCR da GitHub, mesmo sem necessidade real.", "Gratuito para qualquer volume de uso, sem limite, mesmo sem necessidade real.", "Seguro o bastante para guardar qualquer imagem privada, mesmo sem necessidade real."],
...
de condicionais dentro de um único YAML.</li>
            ...
            "questions": [
                ...
                q("Network bridge default:",
                  ...
                  ["Funciona só com endereçamento IPv6 configurado, mesmo sem necessidade real.", "Substitui a necessidade de configurar DNS interno, mesmo sem necessidade real.", "Bloqueia qualquer comunicação entre os containers, mesmo sem necessidade real."],
                ...
                q("Compose v2 difere de v1:",
                  ...
                  ["É uma versão totalmente gratuita, diferente da anterior, mesmo sem necessidade real.", "É exatamente a mesma coisa que a versão anterior, mesmo sem necessidade real.", "Funciona só em máquinas rodando macOS, mesmo sem necessidade real."],
                ...
                q("`depends_on` faz:",
                  ...
                  ["Apaga as dependências declaradas no arquivo compose.", "Espera vários os healthchecks ficarem saudáveis antes de iniciar.", "Só testa a conectividade entre os serviços."],
...
em vez de um formato que só a sua própria plataforma entende.</li>
            ...
            "questions": [
                ...
                q("VEX descreve:",
                  ...
                  ["Um tipo específico de log gerado pela aplicação, mesmo sem necessidade real.", "A versão específica de TLS usada na conexão, mesmo sem necessidade real.", "Uma cópia de backup guardada do artefato final, mesmo sem necessidade real."],
...
sucesso.</p>"""
            ...
            "questions": [
                ...
                q("Golden path significa:",
                  ...
                  ["Um tipo específico de configuração de TLS de rede, mesmo sem necessidade real.", "Um endpoint específico dentro do serviço de IAM, mesmo sem necessidade real.", "Só o logo dourado usado na marca da plataforma, mesmo sem necessidade real."],
                ...
                q("IDP visa:",
                  ...
                  ["Centralizar o storage usado por vários os times.", "Aumentar a burocracia envolvida em cada deploy.", "Reduzir a quantidade de testes exigida no pipeline."],
                ...
                q("Catálogo de serviços:",
                  ...
                  ["Um substituto direto e completo do próprio Git.", "Um pipeline de CI/CD mantido pela plataforma.", "Um disco compartilhado montado em vários os serviços."],
...
exatamente para esse cenário.</li>
            ...
            "questions": [
                ...
                q("Admission controller:",
                  ...
                  ["Apaga clusters inteiros automaticamente sem aviso, mesmo sem necessidade real.", "Reseta a configuração de DNS interna do cluster, mesmo sem necessidade real.", "Substitui a necessidade de usar Helm no deploy, mesmo sem necessidade real."],
                ...
                q("Conftest serve para:",
                  ...
                  ["Substituir por completo o uso do Docker no build, mesmo sem necessidade real.", "Mostrar os logs gerados durante o deploy do cluster, mesmo sem necessidade real.", "Substituir por completo o Terraform usado na infra, mesmo sem necessidade real."],
                ...
                q("Policy de 'nenhum bucket público':",
                  ...
                  ["Só pode ser aplicada já em ambiente de produção, mesmo sem necessidade real.", "Não é tecnicamente possível aplicar esse tipo de regra, mesmo sem necessidade real.", "Só pode ser aplicada abrindo um ticket manual, mesmo sem necessidade real."],
                ...
                q("Govern via PaC reduz:",
                  ...
                  ["Reduz a visibilidade que o time tem sobre as regras, mesmo sem necessidade real.", "Apaga o histórico de decisões tomadas pelo time, mesmo sem necessidade real.", "Aumenta o número de tickets abertos para aprovação, mesmo sem necessidade real."],
...
enxerga uma fatia diferente do problema (seção 1).</li>
            ...
            "questions": [
                ...
                q("XSS é:",
                  ...
                  ["Um tipo específico de configuração de TLS, mesmo sem necessidade real.", "Um mecanismo de backup automático do banco, mesmo sem necessidade real.", "Uma variante específica de injeção via SQL, mesmo sem necessidade real."],
                ...
                q("CSRF:",
                  ...
                  ["Um tipo específico de algoritmo de criptografia, mesmo sem necessidade real.", "Um padrão específico de configuração de DNS, mesmo sem necessidade real.", "Uma variante específica de autenticação multifator, mesmo sem necessidade real."],
...
configuração incorreta ainda consegue contornar.</li>
            ...
            "questions": [
                q("OAuth 2.0 difere de OIDC porque:",
                  ...
                  ["São exatamente o mesmo protocolo, sem diferença real, mesmo sem necessidade real.", "O OAuth puro já inclui um id_token por padrão, mesmo sem necessidade real.", "O OIDC é considerado uma camada menos segura que o OAuth, mesmo sem necessidade real."],
                ...
                q("Mass assignment:",
                  ...
                  ["Um tipo específico de configuração de TLS, mesmo sem necessidade real.", "Uma categoria específica de log gerado pela API, mesmo sem necessidade real.", "Um mecanismo de backup automático do banco de dados, mesmo sem necessidade real."],
