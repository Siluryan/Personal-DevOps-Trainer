...
that exist.</li>
            ...
            "questions": [
                q("`docker run` faz:",
                  ...
                  ["Compila a imagem a partir de um Dockerfile local.", "Sobe um registry local para armazenar as imagens.", "Remove um volume junto com os dados persistidos nele."],
                  "`docker run` = `docker create` + `docker start`. Para builds, é `docker build`. "
                  "Quem sobe um registry é `docker run registry:2` — um container como outro "
                  "qualquer, não um comando dedicado; e volume se remove com `docker volume rm`.",
                  statement_en="`docker run` does:",
                  correct_en="Creates and starts a container from an image.",
                  wrong_en=["Compiles the image from a local Dockerfile.", "Starts a local registry to store the images.", "Removes a volume along with the data persisted in it."],
                  explanation_en="`docker run` = `docker create` + `docker start`. For builds, it's "
                  "`docker build`. Starting a registry is `docker run registry:2` — just another "
                  "container, not a dedicated command; volumes are removed with `docker volume rm`."),
                q("Multi-stage build:",
                  "Permite usar imagem maior para build e menor para runtime.",
                  ["Deixa a imagem final maior, com as dependências de compilação.", "Funciona em projeto escrito em Python ou Go.", "Substitui o build feito no CI."],
                  "Ex.: imagem com gcc só na fase de compilação; runtime tem só o binário. "
                  "Ele reduz a imagem final, vale para qualquer linguagem e complementa (não "
                  "substitui) o pipeline de CI, que continua rodando o build.",
                  statement_en="Multi-stage build:",
                  correct_en="Allows using a larger image for the build and a smaller one for runtime.",
                  wrong_en=['Makes the final image larger, carrying all build dependencies.', 'Only works for projects written in Python.', 'Replaces the build done in CI.'],
                ...
                q("Diferença entre image e container:",
                  ...
                  ["A imagem muda de conteúdo sozinha a cada execução.", "O container é só um registro estatístico de uso.", "Imagem e container são o mesmo objeto, com dois nomes na CLI do Docker."],
                  ...
                  wrong_en=["The image changes its own content on every run.", "The container is just a usage statistics record.", "Image and container are the same object, with two names in the Docker CLI."],
                ...
                q("`COPY` vs `ADD`:",
                  ...
                  ["COPY está depreciado e não deve mais ser usado no Dockerfile.", "COPY e ADD fazem exatamente a mesma coisa; a escolha entre os dois é estilo.", "ADD é a opção recomendada mesmo para copiar um arquivo local."],
                  ...
                  wrong_en=["COPY is deprecated and should no longer be used in the Dockerfile.", "COPY and ADD do exactly the same thing; choosing between them is a matter of style.", "ADD is the recommended option even for copying a local file."],
                ...
                q("Por que NÃO usar latest em produção?",
                  ...
                  ["Fazer pull da tag latest costuma ser mais lento que outras tags.", "A tag latest simplesmente não funciona em produção.", "Exige licença paga no Docker Hub."],
                  ...
                  wrong_en=["Pulling the latest tag tends to be slower than other tags.", "The latest tag simply doesn't work in some environments.", "Requires a paid Docker Hub license."],
                ...
                q("Para aplicações stateless:",
                  ...
                  ["Containers atrapalham mais do que ajudam nesse caso.", "Uma VM tradicional costuma ser melhor nesse cenário.", "Containers não trazem vantagem aqui."],
                  ...
                  wrong_en=["Containers get in the way more than they help in this case.", "A traditional VM tends to be better in this scenario.", "Containers bring no advantage here."],
                ...
                q("Imagem de 1 GB para Python:",
                  ...
                  ["Esse tamanho já é considerado ideal para imagem Python.", "Esse tamanho é necessário na grande maioria dos casos.", "Esse tamanho já é o menor tecnicamente possível para o runtime Python."],
                  ...
                  wrong_en=["This size is already considered ideal for a Python image.", "This size is necessary in the vast majority of cases.", "This size is already the smallest technically possible for the Python runtime."],
...
everything still technically available for deployment.</li>
            ...
            "questions": [
                q("Distroless serve para:",
                  ...
                  ["Funciona só para imagens escritas em Python.", "Ter maior performance de rede entre containers.", "Aumentar o volume de logs gerados pela imagem."],
                ...
                q("Pin por digest sha256 garante:",
                  ...
                  wrong_en=['Automatic renewal of the certificate used by the image.', 'A stronger TLS connection between client and registry.', 'Faster image download on pull.'],
                ...
                q("Imagem alpine é:",
                  ...
                  ["Não inclui implementação de libc na imagem.", "Costuma ser mais lenta que outras distros base.", "Tecnicamente idêntica à imagem base do Debian."],
                  ...
                  wrong_en=["It doesn't include any libc implementation in the image.", 'Usually slower than other base distros.', 'Technically identical to the Debian base image.'],
                ...
                q("Rodar como root no container:",
                  ...
                  ["Reduz o uso de CPU consumido pelo processo principal.", "Boa prática recomendada nos guias.", "Necessário na grande maioria dos cenários de produção."],
                  ...
                  wrong_en=['Reduces the CPU usage consumed by the main process.', 'A good practice recommended in the guides.', 'Required in the vast majority of production scenarios.'],
                ...
                q("Capabilities padrão do Docker:",
                  ...
                  ["Devem ser ampliadas com --cap-add para cobrir cenários futuros.", "São imutáveis e não podem ser alteradas pelo operador.", "Não importam de verdade para a segurança do container."],
                  ...
                  wrong_en=['Should be expanded with --cap-add to cover future scenarios.', 'Are immutable and cannot be changed by the operator.', "Don't really matter for container security."],
                ...
                q("Imagem de 4GB com vulnerabilidades:",
                  ...
                  ["Esse tamanho já é considerado ideal para produção.", "Não existe solução real para esse tipo de problema.", "Continue usando a mesma imagem."],
                  ...
                  wrong_en=['That size is already considered ideal for production.', 'There is no real solution for this kind of problem.', 'Keep using the same image.'],
                ...
                q("Wolfi é:",
                  ...
                  wrong_en=['An alternative container runtime to containerd.', 'A direct, complete replacement for Docker Engine.', 'A linter tool for Dockerfiles.'],
                ...
                q("Imutabilidade da imagem:",
                  ...
                  ["O conteúdo muda a cada pull.", "Esse conceito de imutabilidade não existe no Docker.", "Pode mudar de conteúdo mesmo mantendo a mesma tag."],
                  ...
                  wrong_en=['Content changes each pull.', "This concept of immutability simply doesn't exist in Docker.", 'It can change content even while keeping the same tag.'],
                ...
                q("Fix de CVE em imagem base:",
                  ...
                  ["É aplicado automaticamente sem precisar de rebuild.", "Basta esperar o próximo pull.", "Só é necessário quando a imagem roda em cluster K8s."],
                  ...
                  wrong_en=['Is applied automatically without needing a rebuild.', "Just wait for the next pull.", 'Is only needed when the image runs in a K8s cluster.'],
...
blast radius of the other, with no segmentation between them.</li>
            ...
            "questions": [
                q("Docker Hub público é:",
                  ...
                  ["Seguro o bastante para guardar qualquer imagem privada.", "Gratuito para qualquer volume de uso, sem limite.", "Um substituto direto e completo do GHCR da GitHub."],
                  ...
                  wrong_en=['Safe enough to store any private image.', 'Free for any usage volume, with no limit.', "A direct, complete replacement for GitHub's GHCR."],
                ...
                q("Rate limit do Docker Hub:",
                  ...
                  ["Só ocorre em pull de produção.", "Esse tipo de limite simplesmente não existe no Docker Hub.", "Substitui a necessidade de configurar RBAC no registry."],
                  ...
                  wrong_en=['Only happens on production pulls.', "This kind of limit simply doesn't exist on Docker Hub.", 'Replaces the need to configure RBAC on the registry.'],
                ...
                q("Registry self-hosted:",
                  ...
                  ["Dispensa manutenção da equipe.", "Faz rotação automática de credenciais sem configuração.", "Costuma sair mais barato que qualquer opção gerenciada."],
                  ...
                  wrong_en=["Needs no maintenance from the team.", 'Automatically rotates credentials with no configuration.', 'Usually comes out cheaper than any managed option.'],
                ...
                q("Promotion entre ambientes:",
                  ...
                  ["Só funciona promovendo a tag latest entre ambientes.", "Gera um build totalmente novo em cada ambiente.", "Não depende de versionamento de imagem."],
                ...
                q("Webhook em registry:",
                  ...
                  ["Substitui a necessidade de configurar IAM no registry.", "Reduz o custo de armazenamento cobrado pelo registry.", "Apaga imagens antigas do registry."],
                  ...
                  wrong_en=['Replaces the need to configure IAM on the registry.', 'Reduces the storage cost charged by the registry.', 'Deletes old images from the registry.'],
                  explanation_en='Foundation for GitOps with Argo Image Updater or Flux.'),
                q("Cleanup policies:",
                  "Apagam imagens antigas/não usadas.",
                  ["Aumentam o custo mensal cobrado pelo registry.", "Substituem o RBAC do registry.", "Bloqueiam qualquer pull feito a partir do CI."],
                  ...
                  wrong_en=['Increase the monthly cost charged by the registry.', 'Replace the registry RBAC.', 'Block any pull made from CI.'],
                ...
                q("Mirror de imagens públicas:",
                  ...
                  ["Costuma aumentar a latência percebida pelo cliente.", "Quebra a verificação de TLS entre cliente e registry.", "Substitui o build feito no CI."],
                  ...
                  wrong_en=['Usually increases the latency perceived by the client.', 'Breaks TLS verification between client and registry.', 'Replaces the build done in CI.'],
                ...
                q("Para autenticar de fora:",
                  ...
                  ["Reinicie o daemon containerd.", "Conecte usando telnet direto na porta do registry.", "Substitua o servidor de DNS usado pela máquina."],
                  ...
                  wrong_en=['Restart the containerd daemon.', 'Connect using telnet directly to the registry port.', 'Replace the DNS server used by the machine.'],
                ...
                q("Tag por commit SHA:",
                  ...
                  ["É uma prática considerada depreciada pela comunidade.", "Equivale a usar a tag latest.", "Não é considerado uma prática segura pela indústria."],
                  ...
                  wrong_en=['Is considered a deprecated practice by the community.', 'Is the same as using the latest tag.', "Isn't considered a safe practice by the industry."],
...
of conditionals inside a single YAML.</li>
            ...
            "questions": [
                q("Docker Compose é apropriado para:",
                  ...
                  ["Só roda em host Windows.", "Substitui o Kubernetes em qualquer cenário de produção.", "Sistemas distribuídos operando em escala global."],
                  ...
                  wrong_en=['Only runs on Windows hosts.', 'It replaces Kubernetes in any production scenario.', 'Distributed systems operating at global scale.'],
                ...
                q("Swarm e K8s diferem em:",
                  ...
                  ["A cor do logo de cada projeto.", "O idioma principal da documentação oficial de cada uma.", "A linguagem de programação usada para escrever cada uma."],
                  ...
                  wrong_en=["The logo color of each project.", "The primary language of each tool's official documentation.", 'The programming language used to write each one.'],
                ...
                q("Healthcheck em Compose:",
                  ...
                  ["É um campo opcional sem efeito.", "Apaga o container automaticamente após cada execução.", "Substitui a necessidade de configurar logs no serviço."],
                  ...
                  wrong_en=["It's an optional field with no effect.", 'Automatically increases the CPU available to the container.', 'Only works when the cluster is running Kubernetes.'],
                ...
                q("Volumes nomeados em Compose:",
                  ...
                  ["Não persistem dados além do ciclo do container.", "Guardam os dados só em memória RAM temporária.", "Exigem um caminho absoluto fixo no host."],
                ...
                q("Network bridge default:",
                  ...
                  ["Bloqueia qualquer comunicação entre os containers.", "Substitui a necessidade de configurar DNS interno.", "Funciona só com endereçamento IPv6 configurado."],
                  ...
                  wrong_en=['Blocks any communication between containers.', 'Automatically encrypts all traffic between services.', 'Replaces the need to define any network at all.'],
                ...
                q("Compose v2 difere de v1:",
                  ...
                  ["É exatamente a mesma coisa que a versão anterior.", "É uma reescrita em Rust, distribuída como binário estático único.", "Funciona só em máquinas rodando macOS."],
                  "v1 (`docker-compose`) está EOL. Use v2 sempre. A v2 é escrita em Go e instalada "
                  "como plugin em `~/.docker/cli-plugins`, roda em Linux, macOS e Windows, e o "
                  "arquivo `compose.yaml` continua sendo o mesmo formato da v1.",
                  statement_en='Compose v2 differs from v1:',
                  correct_en="It's a Docker CLI plugin (`docker compose`), not a separate binary.",
                  wrong_en=["It's exactly the same thing as the previous version.", 'It is a rewrite in Rust, shipped as a single static binary file.', 'It only works on machines running macOS.'],
                  explanation_en='v1 (`docker-compose`) is EOL. Always use v2. v2 is written in Go and '
                  'installed as a plugin under `~/.docker/cli-plugins`, runs on Linux, macOS and '
                  'Windows, and `compose.yaml` keeps the same format as v1.'),
                q("Para HA em Compose:",
                  "Use deploy.replicas em Swarm ou suba para K8s.",
                  ["O Compose sozinho já garante alta disponibilidade.", "Basta subir o Compose em dois hosts.", "Basta configurar um backup periódico do serviço."],
                  ...
                  wrong_en=['Compose alone already guarantees high availability.', 'Just run Compose on two hosts.', 'HA is unnecessary for any kind of application.'],
                ...
                q("`depends_on` faz:",
                  ...
                  wrong_en=['Deletes the dependencies declared in the compose file.', 'Automatically runs migrations before starting the app.', 'Replaces the need to configure any healthcheck.'],
                  explanation_en='To wait until healthy, use `condition: service_healthy` (Compose v2 spec).'),
                q("Override file:",
                  "Permite sobrepor configs por ambiente.",
                  ["Só funciona para o ambiente de desenvolvimento local.", "Substitui por completo o arquivo compose principal.", "Apaga a rede do compose principal."],
                  ...
                  wrong_en=['Only works for the local development environment.', 'Automatically encrypts secrets in the repository.', 'Deletes the network from the main file.'],
                  explanation_en='Chain: base.yml + override.yml merges; a repeated key overrides.'),
                q("Nomad pode rodar:",
                  "Containers, binários e VMs.",
                  ["Só containers Docker.", "Só consegue rodar aplicações dentro do browser.", "Só consegue rodar workloads dentro de um cluster K8s."],
                  ...
                  wrong_en=['Docker containers only.', 'It completely replaces the need for a container registry.', 'It only runs on the Windows operating system.'],
...
instead of a format only your own platform understands.</li>
            ...
            "questions": [
                q("SBOM é:",
                  ...
                  wrong_en=['A linter tool for checking code style.', 'A type of TLS certificate used in the connection.', 'A Kubernetes orchestrator for containers.'],
                  explanation_en="Includes version, supplier, hash. Lets you answer 'do we have Log4j 2.14?' in seconds."),
                q("Formato aberto popular:",
                  "CycloneDX e SPDX.",
                  ["Um formato de token usado para autenticação.", "SAML e JWT.", "Um arquivo de texto formatado em Markdown."],
                  ...
                  wrong_en=['A token format used for authentication.', 'SAML and JWT.', "A binary format that can't be read by tools."],
                  explanation_en='Both are standards recognized by NIST and used by CISA.'),
                q("SBOM ajuda em:",
                  "Resposta rápida a CVEs.",
                  ["Ajuda a calcular o preço cobrado pelo fornecedor.", "Serve como material de marketing para o produto.", "Ajuste de DNS."],
                  ...
                  wrong_en=['Helping calculate the price charged by the vendor.', 'Automatically compiling the application source code.', 'DNS tuning.'],
                ...
                q("VEX descreve:",
                  ...
                  ["A versão específica de TLS usada na conexão.", "Um tipo específico de log gerado pela aplicação.", "Uma cópia de backup guardada do artefato final."],
                  ...
                  wrong_en=['The specific TLS version used in the connection.', 'The exact size of the Docker image in megabytes.', 'The DNS configuration of the production domain.'],
                ...
                q("SBOM deve ser:",
                  ...
                  wrong_en=['Filled in manually on every new release.', 'Written only in natural language prose.', 'Optional in any regulated environment.'],
                  explanation_en='Manual is stale and inaccurate. Generation at build time is the rule.'),
                q("Syft gera SBOM de:",
                  "Imagens, diretórios, archives.",
                  ["Só consegue gerar SBOM de projetos em Python.", "Só consegue gerar SBOM a partir de arquivo zip.", "Só de imagens Docker."],
                  ...
                  wrong_en=['It can only generate an SBOM for Python projects.', 'It only works on the Windows operating system.', 'Docker images only.'],
                ...
                q("Distribuir SBOM:",
                  ...
                  ["Enviado manualmente por e-mail para o time de segurança.", "Guardado só no laptop local do desenvolvedor.", "Publicado só como PDF no Confluence."],
                  "Cosign attach sbom anexa ao manifest no registry. Quem puxa a imagem pode puxar a SBOM. "
                  "E-mail, laptop e PDF no wiki desacoplam a SBOM do artefato: na hora do incidente "
                  "ninguém sabe qual SBOM corresponde a qual digest de imagem.",
                  statement_en='Distributing an SBOM:',
                  correct_en='Alongside the artifact, in an OCI registry or release attachment.',
                  wrong_en=['Sent manually by email to the security team.', "Stored only on a local developer's laptop.", 'Published exclusively as a PDF in Confluence.'],
                ...
                q("SBOM sem governança é:",
                  ...
                  ["Substitui a necessidade de aplicar qualquer patch.", "Completamente inútil em qualquer cenário de uso.", "Um gerador de patches."],
                  ...
                  wrong_en=['A replacement for the need to apply any patch.', 'Enough on its own to guarantee total security.', 'A patch generator.'],
...
is the pattern that consistently works in documented success cases.</p>"""
            ...
            "questions": [
                q("IDP é:",
                  ...
                  wrong_en=['Just a UI modal for running a linter.', 'A complete replacement for any cloud provider.', 'A type of relational database for microservices.'],
                ...
                q("Golden path significa:",
                  ...
                  ["Um endpoint específico dentro do serviço de IAM.", "Só o logo dourado usado na marca da plataforma.", "Um tipo específico de configuração de TLS entre serviços da malha."],
                  ...
                  wrong_en=['A specific endpoint inside the IAM service.', 'A Kubernetes network protocol exclusive to CNCF.', 'A specific type of TLS configuration between mesh services.'],
                ...
                q("Backstage é:",
                  ...
                  ["Um pipeline de CI mantido internamente pelo Spotify.", "Uma IDE proprietária vendida como produto fechado.", "Um servidor de DNS interno."],
                  ...
                  wrong_en=['A CI pipeline maintained internally by Spotify.', 'A container registry exclusive to the CNCF.', 'An internal DNS server.'],
                  explanation_en='Adopted by Spotify, Netflix, American Airlines, etc. Hosted by the CNCF.'),
                q("IDP visa:",
                  "Reduzir o custo cognitivo da operação.",
                  ["Centralizar o storage dos times.", "Aumentar a burocracia envolvida em cada deploy.", "Reduzir a quantidade de testes exigida no pipeline."],
                  ...
                  wrong_en=['Centralize storage across teams.', 'Eliminate the need for any automated testing.', 'Replace the application source code entirely.'],
                ...
                q("Self-service em IDP:",
                  ...
                  ["Acaba com os testes do pipeline.", "Aumenta a dependência do time de SRE em cada request.", "Substitui a necessidade de configurar RBAC no cluster."],
                  ...
                  wrong_en=['Ends the pipeline tests.', 'Automatically deletes unused microservices.', 'Replaces the need to configure RBAC.'],
                ...
                q("Templates em IDP:",
                  ...
                  ["Reduzem a qualidade do serviço.", "Substituem a etapa de build feita no pipeline de CI.", "Apagam as configurações de segurança do serviço."],
                  ...
                  wrong_en=['Reduce the service quality.', 'Only work for applications written in Java.', 'Replace the need for any kind of documentation.'],
                ...
                q("Catálogo de serviços:",
                  ...
                  ["Um substituto direto e completo do próprio Git.", "Um pipeline de CI/CD da plataforma.", "Um disco compartilhado montado em vários serviços."],
                  ...
                  wrong_en=['A direct, complete replacement for Git itself.', 'A CI/CD pipeline of the platform.', 'A type of TLS certificate for internal APIs.'],
                ...
                q("IDP X K8s diretamente:",
                  ...
                  ["O Kubernetes substitui por completo qualquer IDP.", "São exatamente a mesma coisa, sem diferença real.", "Não têm relação prática entre si."],
                ...
                q("Métrica de sucesso de IDP:",
                  ...
                  ["O número de linhas escritas em cada chart Helm.", "O total de tickets do mês.", "O tamanho do time de SRE responsável pela plataforma."],
                  ...
                  wrong_en=['The number of lines written in each Helm chart.', 'Total tickets opened in the month.', 'The number of Kubernetes nodes in the cluster.'],
                ...
                q("Time topology recomendada:",
                  ...
                  ["Só um time dedicado exclusivamente à segurança.", "Só um time dedicado exclusivamente ao SRE.", "Só os desenvolvedores organizados, sem outro time."],
...
exactly for that scenario.</li>
            ...
            "questions": [
                ...
                q("Kyverno é específico para:",
                  "Kubernetes.",
                  ["Helm charts.", "Cloud Functions.", "Terraform."],
                  "Diferencial: políticas em YAML, sem precisar Rego. Boa entrada para times K8s. "
                  "Helm chart e Terraform são validados por Checkov/OPA/Conftest, e função serverless "
                  "não passa por admission controller — Kyverno vive no apiserver do cluster.",
                  statement_en='Kyverno is specific to:',
                  correct_en='Kubernetes.',
                  wrong_en=['Helm charts.', 'Cloud Functions.', 'Terraform.'],
                  explanation_en='Differentiator: policies in YAML, no Rego needed. A good entry point '
                  'for K8s teams. Helm charts and Terraform are validated by Checkov/OPA/Conftest, and '
                  'serverless functions never hit an admission controller — Kyverno lives in the apiserver.'),
                q("Admission controller:",
                  "Intercepta criação/update de recursos antes de persistir.",
                  ["Apaga clusters inteiros automaticamente, sem aviso ao operador.", "Substitui a necessidade de usar Helm no deploy.", "Reseta a configuração de DNS interna do cluster."],
                  ...
                  wrong_en=['Automatically deletes entire clusters with no warning to the operator.', 'Replaces the need to configure RBAC in the cluster.', 'Only works for applications written in Go.'],
                ...
                q("Conftest serve para:",
                  ...
                  ["Substituir por completo o Terraform usado na infra.", "Mostrar os logs gerados durante o deploy do cluster.", "Substituir por completo o uso do Docker no build."],
                  ...
                  wrong_en=['Completely replacing the Terraform used for infra.', 'Automatically compiling Docker images in CI.', 'Replacing the need for any container registry.'],
                ...
                q("Policy de 'nenhum bucket público':",
                  ...
                  ["Só pode ser aplicada já em ambiente de produção.", "Só pode ser aplicada abrindo um ticket manual.", "Não é tecnicamente possível aplicar esse tipo de regra."],
                  ...
                  wrong_en=['Can only be applied once already in production.', 'Only works for buckets created manually in the console.', 'Replaces the need for any encryption on the data.'],
                ...
                q("Fast feedback ao dev:",
                  ...
                  ["Só rodar a policy já em ambiente de produção.", "Substituir por completo a etapa de CI do pipeline.", "Rodar a policy pelo console."],
                  ...
                  wrong_en=['Only run the policy once already in production.', 'Send the policy result exclusively by postal mail.', 'Run the policy from the console.'],
                ...
                q("Govern via PaC reduz:",
                  ...
                  ["Apaga o histórico de decisões tomadas pelo time.", "Aumenta o número de tickets manuais abertos para aprovação prévia.", "Reduz a visibilidade que o time tem sobre as regras."],
                  ...
                  wrong_en=['Deletes the history of decisions made by the team.', 'The number of manual tickets opened for prior approval.', 'The possibility of reviewing changes in a PR.'],
...
sees a different slice of the problem (section 1).</li>
            ...
            "questions": [
                ...
                q("ZAP em modo baseline:",
                  ...
                  ["Substitui por completo a necessidade de pentest.", "Só analisa o código de infraestrutura em IaC.", "Analisa só o código do frontend."],
                  ...
                  wrong_en=['Completely replaces the need for a pentest.', 'Only works against applications written in Java.', 'Only analyzes the frontend code.'],
                ...
                q("XSS é:",
                  ...
                  ["Um tipo específico de configuração de TLS.", "Um mecanismo de backup automático do banco.", "Uma variante específica de injeção via SQL."],
                  "Reflected, stored, DOM-based. Mitigação: output encoding, CSP.",
                  statement_en='XSS is:',
                  correct_en='Cross-site scripting — JS injection via input.',
                  wrong_en=['A specific type of TLS configuration.', 'A DNS configuration pattern for the domain.', 'A type of relational database backup.'],
                  explanation_en='Reflected, stored, DOM-based. Mitigation: output encoding, CSP.'),
                q("SQLi é:",
                  "SQL Injection, input que altera queries.",
                  ["Um problema que só ocorre em documentos XML.", "Um problema que costuma acontecer no browser.", "Uma configuração de DNS."],
                  ...
                  wrong_en=['A problem that only occurs in XML documents.', 'A type of TLS certificate used in the connection.', 'A DNS configuration.'],
                ...
                q("Idealmente DAST roda:",
                  ...
                  ["Manualmente, testando direto em produção real.", "Uma vez por ano, sem CI.", "Simplesmente não roda em pipeline de CI."],
                  ...
                  wrong_en=['Manually, testing directly against real production.', 'Once a year, without CI.', "Exclusively on the developer's laptop with no CI."],
                ...
                q("Auth em DAST:",
                  ...
                  ["Bloqueia a execução do scan.", "É totalmente opcional em qualquer cenário.", "Substitui a necessidade de usar senha no login."],
                  ...
                  wrong_en=['Blocks the scan from running.', 'Replaces the need for any authorization check in the app.', 'Only works with basic authentication.'],
                ...
                q("Headers de segurança:",
                  ...
                  ["Só verifica a configuração de TLS da conexão.", "Verifica só os registros DNS.", "Só verifica os resultados de uma análise SAST."],
                  ...
                  wrong_en=['It only verifies the TLS configuration of the connection.', "It only checks the DNS records.", 'It only verifies the results of a SAST analysis.'],
                ...
                q("CSRF:",
                  ...
                  ["Um tipo específico de algoritmo de criptografia.", "Um padrão específico de configuração de DNS.", "Uma variante de autenticação multifator que usa token de hardware pelo navegador."],
                  ...
                  wrong_en=['A specific type of encryption algorithm.', 'A specific DNS configuration pattern.', 'A variant of multifactor authentication that uses a hardware token in the browser.'],
                ...
                q("Pentest difere de DAST porque:",
                  ...
                  ["O DAST é feito de forma totalmente manual por humanos.", "Não há diferença entre os dois.", "O pentest é feito só rodando scripts automatizados."],
                  ...
                  wrong_en=['DAST is done entirely manually by humans.', 'There is no difference between the two.', 'Pentesting is done only by running automated scripts.'],
                ...
                q("DAST exige consentimento:",
                  ...
                  wrong_en=['Only required when using a corporate VPN.', 'No, any system can be tested freely.', 'Only allowed to test during the weekend.'],
...
configuration can still work around.</li>
            ...
            "questions": [
                q("OAuth 2.0 difere de OIDC porque:",
                  ...
                  ["São exatamente o mesmo protocolo, sem diferença real.", "O OAuth puro já inclui um id_token por padrão.", "O OIDC é considerado uma camada menos segura que o OAuth."],
                  ...
                  wrong_en=['They are exactly the same protocol, with no real difference.', 'Pure OAuth already includes an id_token by default.', 'OIDC is considered a less secure layer than OAuth.'],
                ...
                q("BOLA (Broken Object Level Auth):",
                  ...
                  wrong_en=['A cryptography algorithm considered weak.', 'A specific type of TLS configuration.', 'A bug bounty program for found vulnerabilities.'],
                  explanation_en='An API that accepts /orders/{id} without checking whether the user owns the order.'),
                q("Rate limit ajuda contra:",
                  "Brute force e DoS.",
                  ["Latência da API.", "Configuração de TLS da conexão.", "Formato dos logs."],
                  ...
                  wrong_en=['API latency.', 'TLS configuration of the connection.', 'Log format.'],
                ...
                q("Token JWT deve:",
                  ...
                  ["Ser eterno, sem data de expiração definida.", "Conter a senha do usuário em texto plano no payload.", "Ser emitido sem assinatura criptográfica."],
                ...
                q("API Gateway serve para:",
                  ...
                  ["Apagar microserviços sem uso.", "Substituir por completo o cluster de Kubernetes.", "Substituir a necessidade de configurar IAM na conta."],
                  ...
                  wrong_en=['Deleting unused microservices.', 'Completely replacing the Kubernetes cluster.', 'Replacing the need to configure IAM on the account.'],
                ...
                q("Mass assignment:",
                  ...
                  ["Um tipo específico de configuração de TLS.", "Uma categoria específica de log gerado pela API.", "Um mecanismo de backup automático do banco disparado pela API."],
                  ...
                  wrong_en=['A specific type of TLS configuration.', 'A specific category of log generated by the API.', 'An automatic database backup mechanism triggered by the API.'],
                ...
                q("Excessive Data Exposure:",
                  ...
                  ["Um mecanismo de backup automático dos dados da API.", "Uma configuração de DNS.", "Uma técnica de otimização de performance da API."],
                  ...
                  wrong_en=["An automatic backup mechanism for the API's data.", 'A DNS configuration.', 'A technique for optimizing API performance.'],
                ...
                q("Webhook seguro precisa:",
                  ...
                  ["Só funcionar sobre endereçamento IPv6 configurado.", "Funcionar sem autenticação no destino.", "Trafegar por HTTP puro."],
                  ...
                  wrong_en=['To only work over configured IPv6 addressing.', 'To work without authentication at the destination.', 'To travel over plain HTTP.'],
...
API Security lesson.</li>
            ...
            "questions": [
                q("Centralizar logs ajuda em:",
                  ...
                  ["Aumentar a latência entre serviços.", "Substituir a necessidade de manter backup dos dados.", "Reduzir diretamente o custo de infraestrutura do time."],
                  ...
                  wrong_en=['Increasing latency between services.', 'Replacing the need to keep data backups.', "Directly reducing the team's infrastructure cost."],
                  explanation_en='Lets you follow a trace_id across 5 microservices in a single search.'),
                q("Loki indexa:",
                  "Apenas labels, não o conteúdo do log.",
                  ["O conteúdo completo de cada linha.", "Só o timestamp de cada linha de log indexada.", "Só o nível de severidade de cada linha de log."],
                  ...
                  wrong_en=['The full content of every log line.', 'Only the timestamp of each indexed log line.', 'Only the severity level of each log line.'],
                  explanation_en="That's why it's cheap. Content is compressed and read on demand. Substring queries scan."),
                q("ELK stack contém:",
                  "Elasticsearch + Logstash + Kibana.",
                  ["Postgres, Redis e Mongo combinados num só stack.", "Docker, Kubernetes e Helm combinados num só stack.", "Apache, Nginx e HAProxy."],
                  ...
                  wrong_en=['Postgres, Redis and Mongo combined into one stack.', 'Docker, Kubernetes and Helm combined into one stack.', 'Apache, Nginx and HAProxy.'],
                ...
                q("Retenção precisa equilibrar:",
                  ...
                  ["Só a configuração de TLS usada na transmissão.", "Só o SLA do cliente final.", "Só o custo de armazenamento cobrado pelo provedor."],
                  ...
                  wrong_en=['Only the TLS configuration used in transmission.', 'Only the end customer SLA.', 'Only the storage cost charged by the provider.'],
                ...
                q("Anonimização em logs:",
                  ...
                  ["Substitui a necessidade de usar encryption nos dados.", "É uma prática proibida por qualquer regulação vigente.", "É opcional em contexto regulado."],
                  ...
                  wrong_en=['Replaces the need to use encryption on the data.', 'Is a practice forbidden by any current regulation.', 'Is optional in a regulated context.'],
                  explanation_en='Hash emails, mask CPF (***.***.123-45). LGPD/GDPR look at this.'),
                q("Vector é:",
                  "Pipeline de logs/metrics performant em Rust.",
                  ["Uma linguagem de programação criada pela Mozilla.", "Um tipo específico de cluster gerenciado do Kubernetes.", "Um banco de série temporal."],
                  ...
                  wrong_en=['A programming language created by Mozilla.', 'A specific type of managed Kubernetes cluster.', 'A time-series database.'],
                ...
                q("Estruturar logs em JSON:",
                  ...
                  ["Apaga os timestamps de cada linha ao estruturar.", "Dispensa métricas.", "Aumenta em dez vezes o tamanho do arquivo de log."],
                  ...
                  wrong_en=['Deletes the timestamps of every line when structuring.', 'Removes metrics.', 'Increases the log file size tenfold.'],
                ...
                q("Sampling:",
                  ...
                  wrong_en=['Has no effect at all on data volume.', 'Replaces the need to define retention.', 'Increases the total volume of stored data.'],
                ...
                q("Tracing (distributed):",
                  ...
                  ["Substitui por completo a necessidade de manter logs.", "Só funciona para apps web.", "Dispensa métricas."],
                  ...
                  wrong_en=['Completely replaces the need to keep logs.', 'Only works for web apps.', 'Removes metrics.'],
                ...
                q("Log com PII em CW:",
                  ...
                  ["Não traz risco legal.", "É uma prática necessária em qualquer cenário.", "Completamente imune a qualquer tipo de auditoria."],
                  ...
                  wrong_en=['Carries no legal risk.', 'Is a necessary practice in any scenario.', 'Completely immune to any kind of audit.'],
