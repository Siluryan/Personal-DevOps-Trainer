...
"""
            ...
            "questions": [
                q("Sem NetworkPolicy:",
                  ...
                  ["O tráfego entre pods fica bloqueado por padrão.", "Só o tráfego usando a porta TCP 80 é permitido.", "Só o tráfego dentro do mesmo namespace é permitido."],
...
"""
            ...
            "questions": [
                ...
                q("Falha em webhook:",
                  ...
                  ["Não tem efeito real sobre o cluster, suposição incorreta sobre como o sistema realmente se comporta sob estresse.", "Só gera um aviso, sem afetar o comportamento, decisão que cria dívida técnica silenciosa, sem gerar erro imediato.", "Deixa o cluster rodando mais rápido que o normal, atalho que funciona hoje mas complica a próxima migração."],
...
"""
            ...
            "questions": [
                ...
                q("Tetragon difere de Falco:",
                  ...
                  ["Uma ferramenta que não permite configurar regras.", "Duas ferramentas praticamente idênticas em funcionalidade.", "O Falco é escrito inteiramente na linguagem Java."],
...
"""
            ...
            "questions": [
                ...
                q("Chaos em prod:",
                  ...
                  ["Um experimento que costuma ser geralmente destrutivo.", "Uma prática sem necessidade real de existir.", "Uma prática que não deveria ser feita nesse ambiente."],
