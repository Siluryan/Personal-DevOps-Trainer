...
custo.</p>"""
            ...
            "questions": [
                q("Pod é:",
                  ...
                  ["Um tipo específico de recurso Service dentro do cluster, mesmo sem necessidade real.", "O cluster inteiro, com vários nodes e workloads, mesmo sem necessidade real.", "Só a versão instalada do binário kubectl, mesmo sem necessidade real."],
