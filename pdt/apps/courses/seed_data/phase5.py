...
"""
            ...
            "questions": [
                q("Pod é:",
                  ...
                  ["Um tipo específico de recurso Service dentro do cluster.", "O cluster inteiro, com control plane, nodes worker e seus workloads em execução.", "Só a versão instalada do binário kubectl."],
                  ...
                  wrong_en=["A specific type of Service resource inside the cluster.", "The entire cluster, with control plane, worker nodes and their running workloads.", "Just the installed version of the kubectl binary."],
                ...
                q("Deployment garante:",
                  ...
                  ["Substitui a configuração de um Service.", "Funciona só dentro do namespace default do cluster.", "Mantém geralmente exatamente um único pod rodando."],
                  ...
                  wrong_en=["Replaces configuring a Service.", "Only works inside the cluster's default namespace.", "Usually keeps exactly a single pod running."],
                ...
                q("Service do tipo ClusterIP:",
                  ...
                  ["Funciona só sobre endereçamento IPv6 configurado.", "Expõe o serviço diretamente para a internet pública.", "Só aceita tráfego TCP."],
                  ...
                  wrong_en=["Only works over configured IPv6 addressing.", "Exposes the service directly to the public internet.", "Only accepts TCP traffic."],
                ...
                q("Ingress serve para:",
                  ...
                  ["Um tipo de roteamento voltado a armazenamento em disco.", "Só resolve nomes DNS.", "Substitui por completo a necessidade de um Service."],
                  ...
                  wrong_en=["A type of routing aimed at disk storage.", "It only resolves DNS names.", "Completely replaces the need for a Service."],
                ...
                q("ConfigMap e Secret:",
                  ...
                  ["São o mesmo tipo de recurso.", "Funcionam como volume de armazenamento persistente.", "Guardam métricas coletadas do cluster em tempo real."],
                  ...
                  wrong_en=["They are the same type of resource.", "Work as a persistent storage volume.", "Store metrics collected from the cluster in real time."],
                ...
                q("kubectl apply:",
                  ...
                  ["Gera um chart Helm.", "Apaga o cluster inteiro junto com vários nodes.", "Substitui a necessidade de rodar o kubelet no node."],
                  ...
                  wrong_en=["Generates a Helm chart.", "Deletes the entire cluster along with several nodes.", "Replaces the need to run the kubelet on the node."],
                ...
                q("Helm chart é:",
                  ...
                  ["Uma alternativa completa que substitui o próprio kubectl.", "Um arquivo YAML estático, sem template.", "Um banco de dados usado para guardar estado do cluster."],
                ...
                q("Namespace serve para:",
                  ...
                  ["Substitui a necessidade de configurar uma VPC na nuvem.", "Só organiza regras de RBAC.", "Substitui a necessidade de configurar IAM na conta."],
                  ...
                  wrong_en=["Replace the need to configure a VPC in the cloud.", "It only organizes RBAC rules.", "Replace the need to configure IAM on the account."],
                ...
                q("Argo CD entrega via:",
                  ...
                  ["Entrega feita manualmente por alguém do time.", "Entrega feita por transferência de arquivos via FTP.", "Entrega agendada por cron."],
                  ...
                  wrong_en=["Delivery done manually by someone on the team.", "Delivery done by transferring files via FTP.", "Delivery scheduled by cron."],
...
everything else, being static, can't reach.</li>
            ...
            "questions": [
                ...
                q("PodSecurity 'restricted':",
                  ...
                  ["Uma política que só funciona dentro do GKE do Google.", "Uma política que permite root.", "Uma política que praticamente não oferece proteção real."],
                  ...
                  wrong_en=["A policy that only works inside Google's GKE.", "A policy that allows root.", "A policy that offers practically no real protection."],
                ...
                q("NetworkPolicy default deny:",
                  ...
                  ["Aumenta bastante o uso de CPU consumido pelo cluster.", "Apaga os pods afetados.", "Bloqueia completamente grande parte do tráfego do cluster."],
                  ...
                  wrong_en=["Significantly increases the cluster's CPU usage.", "Deletes the affected pods.", "Completely blocks most of the cluster's traffic."],
                ...
                q("Secrets em etcd:",
                  ...
                  ["Só precisam de cripto em produção.", "Já vêm criptografados por padrão em qualquer cluster.", "Não fazem muita diferença para a segurança do cluster."],
                  ...
                  wrong_en=["Only need encryption in production.", "Already come encrypted by default in any cluster.", "Don't make much difference to the cluster's security."],
                  explanation_en="By default, a Secret is just base64 in etcd. Configure EncryptionConfiguration."),
                q("Audit logs em K8s:",
                  "Registram ações na API server.",
                  ["Registram ações só relacionadas diretamente a Pods.", "Substituem a necessidade de coletar métricas do cluster.", "Registram só consultas DNS."],
                  ...
                  wrong_en=["Only record actions directly related to Pods.", "Replace the need to collect metrics from the cluster.", "Only record DNS queries."],
                ...
                q("kube-bench faz:",
                  ...
                  ["Atualiza a versão dos nodes.", "Substitui a necessidade de configurar RBAC no cluster.", "Aplica patches de segurança diretamente nos nodes."],
                  ...
                  wrong_en=["Updates the nodes' version.", "Replaces the need to configure RBAC in the cluster.", "Applies security patches directly to the nodes."],
                ...
                q("ServiceAccount default:",
                  ...
                  ["Substitui a necessidade de configurar IAM na conta.", "Já vem sem token montado por padrão.", "Deve montar o token automaticamente em cada pod criado."],
                ...
                q("Image pull secret:",
                  ...
                  ["Só cuida da resolução de nomes DNS do cluster.", "Substitui a necessidade de configurar RBAC no cluster.", "Apaga imagens antigas."],
                  ...
                  wrong_en=["Only handles DNS name resolution for the cluster.", "Replaces the need to configure RBAC in the cluster.", "Deletes old images."],
                ...
                q("Container privilegiado:",
                  ...
                  ["Um recurso necessário na grande maioria dos deploys.", "Um recurso considerado mais seguro que o padrão.", "Um recurso que acelera o pod."],
                  ...
                  wrong_en=["A feature required in the vast majority of deploys.", "A feature considered more secure than the default.", "A feature that speeds up the pod."],
...
"""
            ...
            "questions": [
                q("Sem NetworkPolicy:",
                  ...
                  ["Tráfego entre pods é negado.", "Só o tráfego usando a porta TCP 80 é permitido.", "Só o tráfego dentro do mesmo namespace é permitido."],
                  ...
                  wrong_en=["Pod-to-pod traffic is denied.", "Only traffic using TCP port 80 is allowed.", "Only traffic within the same namespace is allowed."],
                ...
                q("NP é avaliado no:",
                  ...
                  ["Pelo processo da API server.", "Avaliado pelo controller responsável pelo Ingress.", "Avaliado pelo componente kube-proxy de cada node."],
                  ...
                  wrong_en=["By the API server process.", "Evaluated by the controller responsible for Ingress.", "Evaluated by the kube-proxy component on each node."],
                ...
                q("NP NS-to-NS:",
                  ...
                  ["Tecnicamente não é possível fazer esse tipo de seleção.", "Só funciona selecionando pods do mesmo namespace.", "Só vale em produção."],
                  ...
                  wrong_en=["Technically it is not possible to do that kind of selection.", "Only works by selecting pods in the same namespace.", "It only applies in production."],
                  explanation_en="Label namespaces (e.g. env=prod) and select by those labels."),
                q("Egress policy:",
                  "Limita destinos que pod pode acessar.",
                  ["Limita só saídas em TLS.", "Limita só os headers enviados na requisição.", "Limita só a resolução de nomes DNS feita pelo pod."],
                  ...
                  wrong_en=["Limits only TLS egress.", "Limits only the headers sent in the request.", "Limits only DNS name resolution done by the pod."],
                ...
                q("DNS pode ser quebrado se:",
                  ...
                  ["O Service estiver com o tipo ClusterIP.", "O pod usar hostNetwork em vez da rede do cluster.", "O NetworkPolicy liberar a porta 53 UDP e TCP."],
                  ...
                  wrong_en=["The Service is of type ClusterIP.", "The pod uses hostNetwork instead of the cluster network.", "The NetworkPolicy allows UDP and TCP port 53."],
                  explanation_en="Remember: UDP/TCP port 53 to kube-dns in the kube-system namespace."),
                q("Cilium Hubble:",
                  "Observabilidade do tráfego do cluster.",
                  ["Um ingress controller HTTP.", "Um mecanismo de backup do estado do cluster.", "Um substituto direto e completo do Argo CD."],
                  ...
                  wrong_en=["An HTTP ingress controller.", "A backup mechanism for cluster state.", "A direct and complete substitute for Argo CD."],
                  explanation_en="Shows allowed/denied flows in real time. Useful for NP debugging."),
                q("NP é:",
                  "Aditivo, múltiplas regras se acumulam.",
                  ["Substitutivo, a última regra aplicada sobrescreve as outras.", "Válido só quando aplicado no escopo global do cluster.", "Limitado a uma política por namespace."],
                  "Cada NP soma; final é union. Ordem não importa.",
                  statement_en="NP is:",
                  correct_en="Additive; multiple rules accumulate.",
                  wrong_en=["Substitutive; the last applied rule overwrites the others.", "Valid only when applied at the global cluster scope.", "Limited to one policy per namespace."],
...
"""
            ...
            "questions": [
                q("Validating webhook:",
                  ...
                  ["Substitui a necessidade de configurar RBAC no cluster.", "Altera o recurso enviado antes de aprovar o pedido.", "Apaga o recurso recebido."],
                  ...
                  wrong_en=["Replaces the need to configure RBAC in the cluster.", "Changes the submitted resource before approving the request.", "Deletes the received resource."],
                  explanation_en="Mutating changes (e.g. sidecar injection); validating only decides."),
                q("Mutating webhook:",
                  "Modifica o recurso (ex.: injetar sidecar).",
                  ["Só cuida da resolução de nomes DNS do cluster.", "Só valida o recurso, sem alterá-lo.", "Só gera uma linha de log sobre o recurso recebido."],
                  ...
                  wrong_en=["Only handles DNS name resolution for the cluster.", "Only validates the resource, without changing it.", "Only writes a log line about the received resource."],
                ...
                q("Gatekeeper baseia-se em:",
                  ...
                  ["Um arquivo YAML estático, sem lógica de validação.", "Um conjunto de scripts escritos em Bash.", "Um conjunto de comandos rodados direto no shell."],
                ...
                q("Kyverno é:",
                  ...
                  ["Um recurso que funciona só sobre endereçamento IPv6.", "Um substituto direto e completo do próprio kubectl.", "Uma engine embutida no Helm."],
                  ...
                  wrong_en=["A resource that only works over IPv6 addressing.", "A direct and complete substitute for kubectl itself.", "An engine built into Helm."],
                ...
                q("Admission protege contra:",
                  ...
                  ["Só cobre backup do etcd.", "Recursos que já foram criados e estão rodando no cluster.", "Só cobre a criação de recursos do tipo Service."],
                  ...
                  wrong_en=["Only covers etcd backup.", "Resources that were already created and are running in the cluster.", "Only covers creation of Service-type resources."],
                  explanation_en="A running pod needs runtime security (Falco/Tetragon)."),
                q("Modo audit:",
                  "Apenas registra violações sem bloquear.",
                  ["Bloqueia grande parte da tentativa de criação que viole a regra.", "Apaga grande parte do recurso que viole a regra configurada.", "Substitui os logs do cluster."],
                  ...
                  wrong_en=["Blocks most creation attempts that violate the rule.", "Deletes most of the resource that violates the configured rule.", "Replaces the cluster's logs."],
                ...
                q("Limite de admission:",
                  ...
                  ["Enxerga qualquer problema, inclusive depois do deploy.", "Substitui a necessidade de ter monitoring configurado no cluster.", "Substitui a necessidade de manter logs do cluster."],
                  ...
                  wrong_en=["Sees any problem, including after deploy.", "Replaces the need to have monitoring configured in the cluster.", "Replaces the need to keep cluster logs."],
                ...
                q("Falha em webhook:",
                  ...
                  ["Não tem efeito real sobre o cluster.", "Só gera um aviso no log do API server, sem afetar o comportamento do cluster.", "Deixa o cluster rodando mais rápido que o normal."],
                  ...
                  wrong_en=["Has no real effect on the cluster.", "Only writes a warning in the API server log, without affecting the cluster.", "Makes the cluster run faster than normal."],
...
"""
            ...
            "questions": [
                ...
                q("Micro-segmentação:",
                  ...
                  ["Substitui a necessidade de configurar IAM na conta.", "Uma técnica que só faz sentido para tráfego web.", "Costuma aumentar a latência percebida pelo usuário final da aplicação."],
                  ...
                  wrong_en=["Replaces the need to configure IAM on the account.", "A technique that only makes sense for web traffic.", "Usually increases the latency perceived by the application's end user."],
                ...
                q("Service mesh ajuda em:",
                  ...
                  ["Cuida só da resolução de nomes DNS entre serviços.", "Funciona só como cache L7.", "Substitui a necessidade de manter um ingress no cluster."],
                  ...
                  wrong_en=["Only handles DNS name resolution between services.", "Only works as an L7 cache.", "Replaces the need to keep an ingress in the cluster."],
                ...
                q("VPN tradicional vs Zero Trust:",
                  ...
                  ["Os dois modelos concedem exatamente o mesmo tipo de acesso.", "A VPN tradicional oferece um controle mais granular que o ZT.", "Zero Trust é menos seguro que VPN."],
                  ...
                  wrong_en=["Both models grant exactly the same type of access.", "Traditional VPN offers more granular control than ZT.", "Zero Trust is less secure than VPN."],
                ...
                q("Identidade forte exige:",
                  ...
                  ["SMS como único fator.", "Depender só de uma senha para autenticar o acesso.", "Depender só de um endereço IP fixo para autenticar."],
                  ...
                  wrong_en=["SMS as the only factor.", "Relying only on a password to authenticate access.", "Relying only on a fixed IP address to authenticate."],
                ...
                q("Tailscale baseado em:",
                  ...
                  ["Um protocolo baseado inteiramente em L2TP.", "Um túnel PPTP legado.", "Um protocolo baseado só em IPSec, sem identidade."],
                  ...
                  wrong_en=["A protocol based entirely on L2TP.", "A legacy PPTP tunnel.", "A protocol based only on IPSec, without identity."],
                ...
                q("Continuous authorization:",
                  ...
                  ["Avalia a decisão só no momento do login inicial.", "Avalia a decisão só no momento do logout do usuário.", "Depende de revisão manual."],
                  ...
                  wrong_en=["Evaluates the decision only at initial login time.", "Evaluates the decision only when the user logs out.", "Depends on manual review."],
                  explanation_en="Risk changed (new IP, device lost compliance)? Session is ended/elevated."),
                q("ZT NÃO é:",
                  "Apenas comprar uma ferramenta.",
                  ["Um conjunto de práticas apoiado por padrões do NIST.", "Um modelo adotado aos poucos.", "Uma combinação de filosofia de segurança e arquitetura."],
                  ...
                  wrong_en=["A set of practices backed by NIST standards.", "A model adopted gradually.", "A combination of security philosophy and architecture."],
...
"""
            ...
            "questions": [
                ...
                q("eBPF permite:",
                  ...
                  ["Um recurso que só está disponível rodando em macOS.", "Exige recompilar o kernel.", "Só funciona quando o processo roda como usuário root."],
                  ...
                  wrong_en=["A feature that is only available when running on macOS.", "Requires recompiling the kernel.", "Only works when the process runs as the root user."],
                ...
                q("Detecção runtime complementa:",
                  ...
                  ["Dispensa configurar IAM.", "Substitui por completo vários outros controles existentes.", "Substitui a necessidade de manter logs do cluster."],
                  ...
                  wrong_en=["Removes the need to configure IAM.", "Completely replaces several other existing controls.", "Replaces the need to keep cluster logs."],
                  explanation_en="Defense in depth: prevent + detect + respond."),
                q("Shell em pod produção é:",
                  "Sinal a investigar, geralmente anomalia.",
                  ["Rotina normal de operação.", "Uma prática recomendada pela maioria dos guias de operação.", "Uma situação comum e esperada em ambiente de produção."],
                  ...
                  wrong_en=["Normal operating routine.", "A practice recommended by most operations guides.", "A common and expected situation in a production environment."],
                ...
                q("Tetragon difere de Falco:",
                  ...
                  ["Uma ferramenta que não permite configurar regras.", "Duas ferramentas praticamente idênticas em funcionalidade.", "O Falco é escrito em Java."],
                  ...
                  wrong_en=["A tool that does not allow configuring any rule.", "Two tools that are practically identical in functionality.", "Falco is written in Java."],
                ...
                q("Sidecar de monitoramento:",
                  "Pode aumentar overhead.",
                  ["Um componente que só funciona rodando como DaemonSet.", "Não gera overhead.", "Um componente considerado obrigatório em qualquer cluster."],
                  "Prefira modo eBPF/host: DaemonSet com eBPF tem footprint menor que sidecar por pod.",
                  statement_en="Monitoring sidecar:",
                  correct_en="Can increase overhead.",
                  wrong_en=["A component that only works as a DaemonSet.", "Adds no overhead.", "A component that is mandatory on any cluster."],
                  explanation_en="Prefer eBPF/host mode: a DaemonSet with eBPF has a smaller footprint than a sidecar per pod."),
                q("Falsos positivos:",
                  "Devem ser tunados via regras customizadas.",
                  ["Devem ser ignorados.", "Devem levar à desativação completa da ferramenta.", "Devem ser resolvidos trocando de ferramenta de detecção."],
                  ...
                  wrong_en=["Should be ignored.", "Should lead to completely disabling the tool.", "Should be solved by switching detection tools."],
                ...
                q("Resposta a alerta runtime:",
                  ...
                  ["Apagar os logs relacionados ao alerta recebido.", "Ignorar até o alerta parar.", "Reiniciar vários serviços do cluster de uma vez."],
                  ...
                  wrong_en=["Deleting the logs related to the received alert.", "Ignore it until the alert stops.", "Restarting several cluster services at once."],
                ...
                q("Observabilidade runtime:",
                  ...
                  ["Substitui a necessidade de coletar métricas do cluster.", "Só serve para debug manual.", "Praticamente não funciona bem em ambiente de produção."],
                  ...
                  wrong_en=["Replaces the need to collect cluster metrics.", "Only useful for manual debugging.", "Practically does not work well in a production environment."],
...
"""
            ...
            "questions": [
                q("Trace é:",
                  ...
                  ["Uma única linha registrada num arquivo de log.", "Uma métrica que mede o uptime geral do serviço ao longo do mês.", "Só um registro relacionado à resolução de DNS."],
                  ...
                  wrong_en=["A single line recorded in a log file.", "A metric that measures overall service uptime over the month.", "Just a record related to DNS resolution."],
                ...
                q("OpenTelemetry padroniza:",
                  ...
                  ["Padroniza só métricas.", "Padroniza só a coleta de logs gerados pelo serviço.", "Funciona só em projetos escritos na linguagem Java."],
                  ...
                  wrong_en=["Standardizes only metrics.", "Standardizes only the collection of logs generated by the service.", "Only works on projects written in the Java language."],
                ...
                q("Correlation entre logs e traces:",
                  ...
                  ["Tecnicamente não é possível fazer esse tipo de correlação.", "Substitui a necessidade de configurar IAM na conta.", "Depende do DNS do serviço."],
                  ...
                  wrong_en=["Technically it is not possible to do that kind of correlation.", "Replaces the need to configure IAM on the account.", "Depends on the service's DNS."],
                ...
                q("Service map:",
                  ...
                  ["Um recurso disponível só na linguagem de consulta Cypher.", "Um tipo específico de configuração de TLS.", "Um mapa físico da disposição dos racks e cabos no datacenter."],
                  ...
                  wrong_en=["A feature available only in the Cypher query language.", "A specific type of TLS configuration.", "A physical map of rack and cable layout in the datacenter."],
                ...
                q("RED method:",
                  ...
                  ["Um mecanismo de backup dos dados persistidos pelo serviço.", "Uma camada de cache usada pelo serviço.", "Um conjunto de registros relacionados a DNS."],
                  ...
                  wrong_en=["A backup mechanism for data persisted by the service.", "A cache layer used by the service.", "A set of records related to DNS."],
                  explanation_en="Per endpoint. Combine with USE for a complete view."),
                q("Cardinalidade alta:",
                  "Pode quebrar backends de métricas.",
                  ["Praticamente não faz diferença para o backend usado.", "Costuma acelerar bastante as consultas feitas ao backend.", "Reduz o custo de storage."],
                  ...
                  wrong_en=["Practically makes no difference to the backend in use.", "Usually greatly speeds up queries made to the backend.", "Reduces storage cost."],
...
"""
            ...
            "questions": [
                q("Chaos engineering:",
                  ...
                  ["Testes rodados sem hipótese definida antes.", "Apagar dados de produção de forma direta e sem plano.", "Invadir o sistema usando ações completamente aleatórias."],
                ...
                q("Game day:",
                  ...
                  ["Um backup automático.", "Uma confraternização organizada pelo time de plantão.", "Um ataque de negação de serviço feito contra o público."],
                  ...
                  wrong_en=["An automated backup.", "A social gathering organized by the on-call team.", "A denial-of-service attack against the public."],
                ...
                q("Hipótese científica:",
                  ...
                  ["Algo que inviabiliza a realização de qualquer experimento.", "Algo só do meio acadêmico.", "Um detalhe sem muita importância para o resultado final."],
                  ...
                  wrong_en=["Something that makes any experiment impossible to run.", "Something only from academia.", "A detail of little importance to the final result."],
                ...
                q("Blast radius:",
                  ...
                  ["Um limite só de dev.", "Um limite que geralmente acaba cobrindo o sistema inteiro.", "Um limite restrito só à resolução de nomes DNS."],
                  ...
                  wrong_en=["A limit only for dev.", "A limit that usually ends up covering the entire system.", "A limit restricted only to DNS name resolution."],
                ...
                q("Métrica chave:",
                  ...
                  ["O custo do incidente.", "O número de requisições por segundo do serviço.", "O tamanho em disco do arquivo de log gerado."],
                  ...
                  wrong_en=["The cost of the incident.", "The number of requests per second of the service.", "The on-disk size of the generated log file."],
                  explanation_en="Detect and recover fast = smaller impact. Chaos measures both."),
                q("Chaos em prod:",
                  "Sim, com cuidado e plano de rollback.",
                  ["Um experimento que costuma ser geralmente destrutivo.", "Uma prática sem valor.", "Uma prática que não deveria ser feita nesse ambiente."],
                  ...
                  wrong_en=["An experiment that tends to be generally destructive.", "A practice with no value.", "A practice that should not be done in that environment."],
                ...
                q("LitmusChaos é:",
                  ...
                  ["Um substituto do Argo CD.", "Um mecanismo de backup do estado do cluster.", "Um ambiente de desenvolvimento integrado (IDE)."],
                  ...
                  wrong_en=["A substitute for Argo CD.", "A backup mechanism for cluster state.", "An integrated development environment (IDE)."],
                  explanation_en="CNCF incubating. CRDs for experiments versioned in Git."),
                q("Sem aprendizado pós-experimento:",
                  "Chaos vira teatro.",
                  ["O ganho se mantém.", "Uma prática que continua agregando valor real ao time.", "Um cenário que dificilmente chega a acontecer na prática."],
                  ...
                  wrong_en=["The benefit still holds.", "A practice that keeps adding real value to the team.", "A scenario that hardly ever happens in practice."],
                ...
                q("Postmortem em chaos:",
                  ...
                  ["Tarefa de uma pessoa só.", "Algo relevante só quando houve downtime real no sistema.", "Substitui a necessidade de rodar o experimento em si."],
                  ...
                  wrong_en=["A one-person task.", "Something relevant only when there was real system downtime.", "Replaces the need to run the experiment itself."],
...
"""
            ...
            "questions": [
                ...
                q("Runbook deve ser:",
                  ...
                  ["Um documento pensado só na teoria, sem uso prático.", "Um documento só em e-mail.", "Um documento confidencial que raramente chega a ser testado."],
                  ...
                  wrong_en=["A document designed only in theory, with no practical use.", "A document that lives only in email.", "A confidential document that is rarely ever tested."],
                  explanation_en="Without testing, a runbook has a 50% chance of being wrong when it matters."),
                q("Containment é:",
                  "Limitar avanço do invasor.",
                  ["Fazer um comunicado direto para a imprensa sobre o caso.", "Apagar evidências relacionadas ao incidente em andamento.", "Reiniciar a produção."],
                  ...
                  wrong_en=["Issuing a direct press statement about the case.", "Deleting evidence related to the ongoing incident.", "Restarting production."],
                  explanation_en="Short term: cut access. Long term: eradicate persistence."),
                q("Postmortem deve:",
                  "Ser blameless e gerar action items.",
                  ["Punir o responsável.", "Ser mantido em sigilo dentro da liderança do time.", "Esconder o que de fato aconteceu durante o incidente."],
                  ...
                  wrong_en=["Punish the person responsible.", "Be kept secret within team leadership.", "Hide what actually happened during the incident."],
                ...
                q("SOAR automatiza:",
                  ...
                  ["Substitui o antivírus.", "Cuida só da resolução de nomes DNS durante o incidente.", "Substitui a necessidade de manter um SIEM configurado."],
                  ...
                  wrong_en=["Replaces the antivirus.", "Only handles DNS name resolution during the incident.", "Replaces the need to keep a SIEM configured."],
                ...
                q("Comunicação durante incidente:",
                  ...
                  ["Resolver o incidente sem comunicar ninguém.", "Comunicar o incidente só por e-mail para o time.", "Coordenar a resposta usando o WhatsApp pessoal de alguém."],
                ...
                q("Severidade SEV1:",
                  ...
                  ["Um aviso considerado de baixa relevância para o time.", "Um bug encontrado ainda em ambiente de desenvolvimento.", "Um erro visual na UI."],
                  ...
                  wrong_en=["A warning considered of low relevance to the team.", "A bug found still in a development environment.", "A visual glitch in the UI."],
...
"""
            ...
            "questions": [
                q("LGPD aplica-se a:",
                  ...
                  ["Só dados já públicos.", "Só empresas brasileiras que exportam para fora do país.", "Só o tratamento de dados pessoais de menores de idade."],
                  ...
                  wrong_en=["Only data that is already public.", "Only Brazilian companies that export abroad.", "Only the processing of personal data of minors."],
                ...
                q("DPIA / RIPD:",
                  ...
                  ["Uma configuração de TLS.", "Um mecanismo de backup dos dados da aplicação.", "Um conjunto de registros relacionados a DNS."],
                  ...
                  wrong_en=["A TLS configuration.", "A backup mechanism for application data.", "A set of records related to DNS."],
                ...
                q("ISO 27001 é:",
                  ...
                  ["Um provedor específico de serviços em nuvem.", "Um tipo específico de algoritmo de criptografia simétrica.", "Um servidor responsável pela resolução de DNS."],
                  ...
                  wrong_en=["A specific cloud service provider.", "A specific type of symmetric encryption algorithm.", "A server responsible for DNS resolution."],
                ...
                q("SOC 2 Type II:",
                  ...
                  ["Uma etapa considerada relevante só na fase de design.", "Um selo usado só para fins de marketing da empresa.", "Uma certificação relevante só dentro do escopo do PCI DSS 4.0."],
                  ...
                  wrong_en=["A stage considered relevant only in the design phase.", "A seal used only for company marketing purposes.", "A certification relevant only within the PCI DSS 4.0 scope."],
                ...
                q("Continuous compliance:",
                  ...
                  ["Uma planilha de checklist preenchida manualmente.", "Uma auditoria anual.", "Ignorar o assunto até a chegada de um auditor."],
                  ...
                  wrong_en=["A checklist spreadsheet filled in manually.", "A yearly audit.", "Ignoring the topic until an auditor arrives."],
                ...
                q("DPO é:",
                  ...
                  ["Um cargo genérico de TI.", "Uma função que só existe dentro do escopo do PCI.", "Um título informal sem responsabilidade formal definida."],
                  "Função obrigatória na LGPD. Pode ser interno ou externo.",
                  statement_en="A DPO is:",
                  correct_en="A data protection officer.",
                  wrong_en=["A generic IT role.", "A function that only exists within the PCI scope.", "An informal title with no formal responsibility defined."],
                ...
                q("PCI DSS aplica-se a:",
                  ...
                  ["Só empresas que operam exclusivamente como SaaS.", "Qualquer e-commerce, mesmo que não processe dados de cartão.", "Só instituições bancárias tradicionais."],
                  ...
                  wrong_en=["Only companies that operate exclusively as SaaS.", "Any e-commerce, even one that does not process card data.", "Only traditional banking institutions."],
