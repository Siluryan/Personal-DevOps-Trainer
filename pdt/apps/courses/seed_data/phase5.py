...
custo.</p>"""
            ...
            "questions": [
                q("Pod é:",
                  ...
                  ["Um tipo específico de recurso Service dentro do cluster, mesmo sem necessidade real.", "O cluster inteiro, com vários os nodes e workloads, mesmo sem necessidade real.", "Só a versão instalada do binário kubectl, mesmo sem necessidade real."],
                ...
                q("kubectl apply:",
                  ...
                  ["Cria um novo chart Helm a partir do manifest.", "Apaga o cluster inteiro junto com vários os nodes.", "Substitui a necessidade de rodar o kubelet no node."],
...
todo o resto, sendo estático, não alcança.</li>
            ...
            "questions": [
                ...
                q("NetworkPolicy default deny:",
                  ...
                  ["Aumenta bastante o uso de CPU consumido pelo cluster.", "Apaga automaticamente os pods afetados pela regra.", "Bloqueia completamente grande parte do o tráfego do cluster."],
                ...
                q("Cluster admin:",
                  ...
                  ["Uma permissão que praticamente não precisa de controle.", "Um acesso que deveria ser concedido a grande parte do o time.", "Um acesso reservado só para pipelines de CI."],
...
organização, construídas sobre a base já validada.</li>
            ...
            "questions": [
                ...
                q("Limite de admission:",
                  ...
                  ["Substitui a necessidade de manter logs do cluster, mesmo sem necessidade real.", "Substitui a necessidade de ter monitoring configurado, mesmo sem necessidade real.", "Enxerga qualquer problema, inclusive depois do deploy, mesmo sem necessidade real."],
                ...
                q("Falha em webhook:",
                  ...
                  ["Não tem algum efeito real sobre o cluster, mesmo sem necessidade real.", "Deixa o cluster rodando mais rápido que o normal, mesmo sem necessidade real.", "Só gera um aviso, sem afetar o comportamento, mesmo sem necessidade real."],
...
programa sustentável.</p>"""
            ...
            "questions": [
                ...
                q("Micro-segmentação:",
                  ...
                  ["Uma técnica que só faz sentido para tráfego web, mesmo sem necessidade real.", "Costuma aumentar a latência percebida pelo usuário, mesmo sem necessidade real.", "Substitui a necessidade de configurar IAM na conta, mesmo sem necessidade real."],
...
necessário.</li>
            ...
            "questions": [
                ...
                q("Detecção runtime complementa:",
                  ...
                  ["Reduz a necessidade de manter IAM configurado.", "Substitui por completo vários os outros controles existentes.", "Substitui a necessidade de manter logs do cluster."],
                ...
                q("Sidecar de monitoramento:",
                  ...
                  ["Um componente considerado obrigatório em qualquer cluster, mesmo sem necessidade real.", "Um componente que só funciona rodando como DaemonSet, mesmo sem necessidade real.", "Um componente que praticamente não gera overhead algum, mesmo sem necessidade real."],
                ...
                q("Resposta a alerta runtime:",
                  ...
                  ["Apagar os logs relacionados ao alerta recebido.", "Ignorar o alerta até que ele pare de aparecer.", "Reiniciar vários os serviços do cluster de uma vez."],
...
plataforma específica.</p>"""
            ...
            "questions": [
                q("Trace é:",
                  ...
                  ["Uma única linha registrada num arquivo de log, mesmo sem necessidade real.", "Só um registro relacionado à resolução de DNS, mesmo sem necessidade real.", "Uma métrica que mede o uptime geral do serviço, mesmo sem necessidade real."],
                ...
                q("Sampling em traces:",
                  ...
                  ["Substitui a necessidade de coletar métricas do serviço.", "Costuma aumentar bastante o custo de armazenamento.", "Descarta praticamente vários os traces coletados."],
                ...
                q("Service map:",
                  ...
                  ["Um tipo específico de configuração de TLS, mesmo sem necessidade real.", "Um mapa físico da disposição dos racks no datacenter, mesmo sem necessidade real.", "Um recurso disponível só na linguagem de consulta Cypher, mesmo sem necessidade real."],
                ...
                q("RED method:",
                  ...
                  ["Um mecanismo de backup dos dados do serviço, mesmo sem necessidade real.", "Um conjunto de registros relacionados a DNS, mesmo sem necessidade real.", "Uma camada de cache usada pelo serviço, mesmo sem necessidade real."],
...
tempo de operação real.</li>
            ...
            "questions": [
                ...
                q("ISO 27001 é:",
                  ...
                  ["Um servidor responsável pela resolução de DNS, mesmo sem necessidade real.", "Um provedor específico de serviços em nuvem, mesmo sem necessidade real.", "Um tipo específico de algoritmo de criptografia, mesmo sem necessidade real."],
                  "Foco em SGSI. Anexo A lista 93 controles. Certificação anual."),
                q("SOC 2 Type II:",
                  "Atesta operação dos controles em um período (ex.: 6 meses).",
                  ["Um selo usado só para fins de marketing da empresa, mesmo sem necessidade real.", "Uma etapa considerada relevante só na fase de design, mesmo sem necessidade real.", "Uma certificação relevante só dentro do escopo do PCI, mesmo sem necessidade real."],
                ...
                q("PCI DSS aplica-se a:",
                  ...
                  ["Só empresas que operam exclusivamente como SaaS, mesmo sem necessidade real.", "Qualquer e-commerce, mesmo sem processar cartões, mesmo sem necessidade real.", "Só instituições bancárias tradicionais, mesmo sem necessidade real."],
